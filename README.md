...
<!-- TODO: Add the public release URL and installation steps when releases are published. -->

Prebuilt releases are not currently documented. Build from source to create a local app bundle.
...
iSnapNuke operates locally. It does not install a background service, collect telemetry, upload snapshot data, or include network communication for its snapshot operations.
